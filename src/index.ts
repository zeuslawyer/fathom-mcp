...
async function main() {
            ...
            try {
                const meetings = (
                    ...
                    return {
                        ...
                        startedAt: m.scheduledStartTime.toLocaleDateString(
                            "En-AU",
                            {
                                year: "numeric",
                                month: "short",
    ...
    server.tool(
        ...
        async args => {
            try {
                const { meetings: allMeetings, hadError } =
                ...
                const formattedMeetings = filteredMeetings.map(m => ({
                    ...
                    scheduledEndTime: m.scheduledEndTime?.toLocaleDateString(
                        undefined,
                        {
                            year: "numeric",
                            month: "short",
